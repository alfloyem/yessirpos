  ...
  <div class="relative group w-full">
    ...
    <div class="relative w-full flex-1">
      ...
      <input 
        ...
        :disabled="disabled"
        :lang="locale"
        class="w-full bg-[var(--input-bg)] border border-[var(--border-app)] font-medium rounded-[14px] outline-none focus:border-[var(--text-primary)] hover:border-[var(--text-muted)] transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed disabled:hover:border-[var(--border-app)] placeholder:font-normal"
        :class="[
